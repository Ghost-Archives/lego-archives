...
function UnlitEnvMaterial( name, baseUrl, envMap, normalScale )
{
    // create material
...
UnlitEnvMaterial.prototype.vert = `
...
UnlitEnvMaterial.prototype.frag = `
...
void main() 
{
    ...
    if ( albedo.a > 0.1 )
    {
        ...
        rgba.rgb += specular * dirlight_color;
